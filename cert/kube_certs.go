...
var (
	KubeprinceConfigDir         = GetUserHomeDir() + "/.kubeprince"
...
type PrinceCertMetaData struct {
	APIServer AltNames
	NodeName  string
	NodeIP    string
	DNSDomain string
...
func NewPrinceCertMetaData(certPATH, certEtcdPATH string, apiServerIPAndDomains []string, SvcCIDR, nodeName, nodeIP, DNSDomain string) (*PrinceCertMetaData, error) {
	data := &PrinceCertMetaData{}
...
func (meta *PrinceCertMetaData) apiServerAltName(certList *[]Config) {
...
func (meta *PrinceCertMetaData) etcdAltAndCommonName(certList *[]Config) {
	altname := AltNames{
		DNSNames: map[string]string{
			"localhost":   "localhost",
...
func (meta *PrinceCertMetaData) generatorServiceAccountKeyPaire() error {
	dir := meta.CertPath
...
func (meta *PrinceCertMetaData) GenerateAll() error {

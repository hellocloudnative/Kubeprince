  ...
  template:
    ...
    spec:
      ...
      initContainers:
        ...
        - name: upgrade-ipam
          image: {{ .CniRepo}}/calico-cni:v3.19.1
        ...
        - name: flexvol-driver
          image: {{ .CniRepo}}/calico-pod2daemon-flexvol:v3.19.1
          volumeMounts:
      ...
      containers:
        ...
        # host.
        - name: calico-node
          image: {{ .CniRepo}}/calico-node:v3.19.1
          envFrom:
          - configMapRef:
              # Allow KUBERNETES_SERVICE_HOST and KUBERNETES_SERVICE_PORT to be overridden for eBPF mode.
              name: kubernetes-services-endpoint
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: calico-kube-controllers
          image: {{ .CniRepo}}/calico-kube-controllers:v3.19.1
          env:

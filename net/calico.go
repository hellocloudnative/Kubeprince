  ...
  template:
    ...
    spec:
      ...
      initContainers:
        ...
        - name: upgrade-ipam
          image: {{ .CniRepo }}/calico-cni:v3.8.2
        ...
        - name: flexvol-driver
          image: {{ .CniRepo }}/calico-pod2daemon-flexvol:v3.8.2
          volumeMounts:
      ...
      containers:
        ...
        # host.
        - name: calico-node
          image: {{ .CniRepo }}/calico-node:v3.8.2
          env:
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: calico-kube-controllers
          image: {{ .CniRepo }}/calico-kube-controllers:v3.8.2
          env:
  ...
  template:
    ...
    spec:
      ...
      initContainers:
        ...
        # upgraded to use calico-ipam.
        - name: upgrade-ipam
          image: {{ .CniRepo }}/calico-cni:v3.14.0
          command: ["/opt/cni/bin/calico-ipam", "-upgrade"]
          env:
            - name: KUBERNETES_NODE_NAME
              valueFrom:
        ...
        # to communicate with Felix over the Policy Sync API.
        - name: flexvol-driver
          image: {{ .CniRepo }}/calico-pod2daemon-flexvol:v3.14.0
          volumeMounts:
          - name: flexvol-driver-host
            mountPath: /host/driver
          securityContext:
      ...
      containers:
        ...
        # host.
        - name: calico-node
          image: {{ .CniRepo }}/calico-node:v3.14.0
          env:
            # Use Kubernetes API as the backing datastore.
            - name: DATASTORE_TYPE
              value: "kubernetes"
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: calico-kube-controllers
          image: {{ .CniRepo }}/calico-kube-controllers:v3.14.0
          env:
            # Choose which controllers to run.
            - name: ENABLED_CONTROLLERS
              value: node

...
type LvsuccImage struct {
	Image string
	Tag   string
}

func (l *LvsuccImage) toImageName() string {
	return l.Image + ":" + l.Tag
}

// return lvscare static pod yaml
func LvsStaticPodYaml(vip string, masters []string, image LvsuccImage) string {
